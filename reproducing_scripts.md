...
```bash
  python -u difusco/train.py \
    --task "tsp" \
    --wandb_logger_name "tsp_diffusion_graph_categorical_tsp50_test" \
    --diffusion_type "categorical" \
    --do_test \
    --learning_rate 0.0002 \
    --weight_decay 0.0001 \
    ...
    --training_split "/data/tsp/tsp100_test_concorde.txt" \
    --validation_split "/data/tsp/tsp100_valid_concorde.txt" \
    --test_split "/your/tsp100_test_concorde.txt" \
    --batch_size 32 \
    --num_epochs 25 \
    --inference_schedule "cosine" \
